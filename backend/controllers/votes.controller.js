  ...
  try {
    ...
    if (vote == 1) {
      ...
      return response.status(201).json({
        results: {
          profile_id: vote.dataValues.profile_id,
          publication_id: vote.dataValues.publication_id,
          updated_at: vote.dataValues.updated_at,
          created_at: vote.dataValues.created_at
        }
      })
    }
  } catch (error) {
